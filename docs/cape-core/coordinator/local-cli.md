...
=== "MacOS"
    ...
    unzip capeprivacy-cape-postgres-v0.0.1.tgz
...
=== "Windows (PowerShell)"
    ...
    5. Download the database schema files from https://github.com/capeprivacy/cape/releases/download/v0.0.1/capeprivacy-cape-postgres-v0.0.1.zip
    6. Unzip the files.
